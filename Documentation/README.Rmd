...
Choosing among the indicators we received from WDI experts on important indicators, below is the chosen list:  
  ...
  5. **Gender Equity:**  Female share of employment in senior and middle management (%)
  ...
  14. **National Accounts:**  Completeness of birth registration (%)
...
## Notes  
  ...
  - Completeness of birth registration (%) recommended by WDI experts  
...
The score for an individual indicator $j$ for a country $i$ is now the fraction of times in a ten year window an indicator is available.

$$ AKI_i^j=\frac{\sum_{t}^{5}{A_{it}^j}}{10} $$
