...
SPI <- SPI %>%
  mutate(SPI=(SPI.D1.MSC+SPI.D2.CS+SPI.D3.AKI+SPI.D4.DPO)/4)

#create version of data in wide format
SPI_wide <- SPI %>%
  select(iso3c, country, date, SPI, SPI.D1.MSC, SPI.D2.CS, SPI.D3.AKI, SPI.D4.DPO) %>%
  pivot_wider(names_from=date,
              names_sep = "_",
              values_from=c('SPI', 'SPI.D1.MSC', 'SPI.D2.CS', 'SPI.D3.AKI', 'SPI.D4.DPO')
              )
...
#export data
write_excel_csv(SPI,
                path = paste(csv_output, "SPI_scores_long_orig.csv", sep="/" ))



write_excel_csv(SPI_wide,
                path = paste(csv_output, "SPI_scores_wide_orig.csv", sep="/" ))
