...
csv_dir <- "C:/Users/wb469649/OneDrive - WBG/Documents/Github/SPI_AKI/R/04_WDR/013_outputs"
...
QGDP %>%
  ...
  summarise(pct=n()/total,
            N=n()) %>%
  kable(caption='% of Countries by Number of Quarterly GDP Values by Region') %>%
  kable_styling()
